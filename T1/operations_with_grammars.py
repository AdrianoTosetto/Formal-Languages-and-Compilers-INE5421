    ...
    for n1 in oldNonTerminals1:
        for p1 in oldProds1:
            ...
            if len(p1.rightSide) > 1 and p1.rightSide[-1] == n1:
                ...
                #p1.rightSide = p1.rightSide.join(str(count))
        count += 1
    count1 = count
    for n2 in oldNonTerminals2:
        for p2 in oldProds2:
            ...
            if len(p2.rightSide) > 1 and p2.rightSide[-1] == n2:
                ...
                #p2.rightSide = p2.rightSide.join(str(count))
        count += 1
    count2 = count
    #---------------------------------------------------------------------------
    for n1 in range(count1):
        for p1 in oldProds1:
            ...
            if len(p1.rightSide) > 1 and p1.rightSide[-1] == str(n1):
                ...
                #p1.rightSide = p1.rightSide.join(alphabet[n1])
    for n2 in range(count2):
        for p2 in oldProds2:
            ...
            if len(p2.rightSide) > 1 and p2.rightSide[-1] == str(n2):
                ...
                #p2.rightSide = p2.rightSide.join(alphabet[n2])
